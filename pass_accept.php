      ...
      <div class="col-12 col-md-8 col-lg-6 mx-auto">
          <div style="background-color: rgb(255,255,255,0.4)" class="p-3 shadow">
                        <div id="d1" style="text-align: center; font-family: fantasy;">
                            <div>Element #d1 aktywny</div>
                        </div>
                        <div id="d2" class="mt-3">
                            <h1 id="h" style="color: tomato; transform: rotate(180deg);">Naglowek #h</h1>
                        </div>
            <?php
                                if (
                                        $_SERVER["REQUEST_METHOD"] === "POST"
                                        && isset($_POST["pws"], $_POST["srt"], $_POST["fName"])
                                        && $_POST["pws"] === base64_decode("VGgxNV8xNV81VFIwbjY")
                                        && $_POST["srt"] === "1352"
                                        && trim($_POST["fName"]) !== ""
                                ) {
                                    echo '<script>
                                        (function () {
                                            ...
                                            if (!div_1 || !div_2 || !header) {
                                                console.warn("Missing required elements: #d1, #d2 or #h");
                                                return;
                                            }
                                            ...
                                            function A1() {
                                                if (div_1.children[0] && div_1.children[0].nodeName === "DIV") {
                                                    console.log("You nailed it !");
                                                    if (div_2.children[0] && div_2.children[0].nodeName === "H1") {
